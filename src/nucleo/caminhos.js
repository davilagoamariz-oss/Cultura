...
export const caminhos = {
  ...
  maquinas: (e) => dentro(e, 'maquinas'),
  maquina: (e, maquinaId) => dentro(e, 'maquinas', id(maquinaId, 'maquinaId')),
  usos: (e, maquinaId) => dentro(e, 'maquinas', id(maquinaId, 'maquinaId'), 'usos'),
  uso: (e, maquinaId, usoId) => dentro(e, 'maquinas', id(maquinaId, 'maquinaId'), 'usos', id(usoId, 'usoId')),
  manutencoes: (e, maquinaId) => dentro(e, 'maquinas', id(maquinaId, 'maquinaId'), 'manutencoes'),
  manutencao: (e, maquinaId, mid) => dentro(e, 'maquinas', id(maquinaId, 'maquinaId'), 'manutencoes', id(mid, 'manutencaoId')),
